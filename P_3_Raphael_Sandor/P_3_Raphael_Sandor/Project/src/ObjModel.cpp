 ...
 * Constructor.
 * 
 * Calls reset object model to initialize object.
 */
 ...
 * 
 * Clears all the stl data structures, places attributes back to defaults.
 * 
 */
void ObjModel::Reset()
{
...
/**
 * Read input file and fill mtl and face data.
 * 
...
/**
 * Draw the material on polygons.
 * 
 * \param mtlName - The material that belong to faces.
 * \param opaque  - Is the material opaque or transparent?
 */
...
/**
 * Wrapper call to draw materials for the two type of objects 
...
/**
 * Sets the diplay mode.
 * 
 * There are three different types of display:
 * WireFrame, Filled, & Point
 * 
 * \param displayMode - Sets the display mode.
 */
